...
<%
    ...
    String WhereDefault = "select distinct a_insertdate, a_result from answer where a_deleted=0 and a_uid = ? and a_category = 2";
    ...
    try {
        ...
        while (rs.next()){
            ...
            tempJson.put("diabetes_insertdate", rs.getString(1));
            tempJson.put("diabetes_rs", rs.getInt(2));
